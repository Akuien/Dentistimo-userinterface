...
>
    <div v-if="currentDentist">
     ...
     <div class="container">
     <b-form @submit.prevent="getRequest">
  ...
  Please Choose From Opening Hours </p>
    ...
    <b-button type="submit" variant="light" :disabled="disableButton" @click="getRequest">
     Book now
     </b-button>
  </b-calendar>
</b-col>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      timeslots: [
        { text: 'Select your prefered time', value: null, disabled: true },
  ...
  methods: {
    ...
    getRequest() {
      ...
      const added2 = thirtyMinutes.toISOString().slice(0, 16)
      const newRequest = {
